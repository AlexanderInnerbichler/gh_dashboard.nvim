...
local HELP = {
  ...
  diff = {
    { key = "<CR> / o",    desc = "Open file under cursor (file panel)" },
    ...
    { key = "S",           desc = "Cycle sort: path / size / status (panel)" },
    { key = "f / F",       desc = "Filter files / toggle generated (panel)" },
    { key = "w",           desc = "Toggle whitespace-only changes (panel)" },
    { key = "O / gy",      desc = "Open on github.com / yank permalink" },
    { key = "zo / zc",     desc = "Open / close fold (zR / zM for all)" },
    { key = "<C-h> / <C-l>", desc = "Focus file panel / diff" },
    { key = "r",           desc = "Refresh" },
