...
local function apply()
  ...
  -- diff viewer
  vim.api.nvim_set_hl(0, "GhDiffPanelPath",     { fg = "#abb2bf"               })
  vim.api.nvim_set_hl(0, "GhDiffPanelDir",      { fg = "#4b5263"               })
  vim.api.nvim_set_hl(0, "GhDiffStatAdd",       { fg = "#a3be8c", bold = true  })
  vim.api.nvim_set_hl(0, "GhDiffStatDel",       { fg = "#e06c75", bold = true  })
  vim.api.nvim_set_hl(0, "GhDiffStatMod",       { fg = "#e5c07b", bold = true  })
  vim.api.nvim_set_hl(0, "GhDiffStatRen",       { fg = "#b48ead", bold = true  })
  vim.api.nvim_set_hl(0, "GhDiffBarAdd",        { fg = "#5b9e5b"               })
  vim.api.nvim_set_hl(0, "GhDiffBarDel",        { fg = "#8f4a52"               })
  vim.api.nvim_set_hl(0, "GhDiffViewed",        { fg = "#5b7a5b"               })
  vim.api.nvim_set_hl(0, "GhDiffCommentAuthor", { fg = "#88c0d0"               })
  vim.api.nvim_set_hl(0, "GhDiffCommentBody",   { fg = "#7a8595", italic = true})
  vim.api.nvim_set_hl(0, "GhDiffCommentPending",{ fg = "#e5c07b", bold = true  })
  vim.api.nvim_set_hl(0, "GhDiffWinbar",        { fg = "#7fc8f8", bold = true  })
  vim.api.nvim_set_hl(0, "GhDiffWinbarDim",     { fg = "#4b5263"               })
  -- notifications
